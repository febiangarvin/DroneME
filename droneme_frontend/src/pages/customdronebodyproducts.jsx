    ...
    return (
        <div>
            ...
            <div style={{ textAlign: 'center', paddingBottom: '15px', marginBottom: '35px' }}>
                <a href='/customdronewingproducts' className="btn-medium mt-1 mb-1" style={{ textAlign: 'center', paddingRight: '15px', paddingBottom: '15px', marginBottom: '25px' }}>
                    Next Item
                </a>
            </div>
            <br />
...
export default CustomDroneBodyProducts;